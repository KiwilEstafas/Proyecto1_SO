...
impl VehicleSpawner {
    ...
    fn spawn_cargo_truck(&mut self, layout: &CityLayout, current_tick: u32, plants: &[crate::model::NuclearPlant]) -> Box<dyn AgentDowncast + Send> {
...
pub fn run_simulation_headless() {
    println!("╔════════════════════════════════════════════════════════════╗");
...
fn spawn_agent(
    ...
    shared_city: &Rc<RefCell<crate::sim::City>>,
    layout: &CityLayout,
