...
//     // --- CAMBIO AQUÍ ---
//     threads.insert(1, Box::new(rr_thread)); // Se envuelve en Box::new()
//     ready_queue.push_back(1);

//     // Hilo RT
//     let rt_thread = MyThread::new(2, "RT".to_string(), SchedulerType::RealTime, 0, Some(50), Box::new(|_| unreachable!()));
//     // --- CAMBIO AQUÍ ---
//     threads.insert(2, Box::new(rt_thread)); // Se envuelve en Box::new()
//     ready_queue.push_back(2);

//     // 2. Ejecución (llamar a la función que quieres probar)
//     // Ahora la llamada a select_next_thread es válida porque `&threads` tiene el tipo correcto.
