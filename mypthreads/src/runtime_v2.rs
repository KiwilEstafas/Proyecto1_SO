...
use crate::thread_v2::{MyThreadV2, ContextThreadEntry, ThreadId, ThreadState, SchedulerType};
...
pub struct ThreadRuntimeV2 {
    now_ms: u64,
    next_tid: ThreadId,
    pub threads: HashMap<ThreadId, MyThreadV2>,
...
impl ThreadRuntimeV2 {
    ...
    pub fn run_once(&mut self) {
        ...
        let thread_ptr = thread as *mut MyThreadV2;
